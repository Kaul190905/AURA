"""
wellness/evaluator.py
---------------------
Computes regression metrics for the AURA Wellness Model on the test split:
...
def evaluate(
    ...
    """
    Evaluate the wellness model on the test split and return a metrics dict.
    """
