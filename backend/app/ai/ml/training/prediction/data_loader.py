"""
prediction/data_loader.py
-------------------------
Loads and validates cleaned datasets for the Prediction training pipeline.
"""
...
def load_and_merge() -> pd.DataFrame:
    """
    Load every aura_*_cleaned.csv file and concatenate them.
    """
...
def drop_duplicates_and_shuffle(df: pd.DataFrame) -> pd.DataFrame:
    """Drop duplicates, shuffle, and reset index."""
    before = len(df)
