#!/usr/bin/env python
"""
train_prediction_model_v2.py
===========================
AURA Overload Prediction Model — Complete Training Pipeline
Capgemini T4PF

This script orchestrates all prediction pipeline stages in order:
...
from app.ai.ml.training.prediction import (
    add_features,
...
from app.ai.ml.training.prediction.config import CSV_PATTERN
...
logger = logging.getLogger("aura.prediction_training")
...
def run_pipeline() -> None:
    ...
    # ── Stage 3: Feature Engineering ──
    stage(3, "Feature Engineering (Temporal & Rolling)")
    df = add_features(df)
    
    # Deduplicate and shuffle after temporal engineering is complete
